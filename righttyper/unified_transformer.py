...
#        return updated_node
    ...
    @staticmethod
    def _format_distribution_comment(traces: list[TraceDistribution]) -> str | None:
        """Formats trace distributions into a comment string.
        ...
        all_arg_names = list(traces[0].args.keys())
